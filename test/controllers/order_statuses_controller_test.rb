...
class OrderStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_status" do
    assert_difference('OrderStatus.count') do
      post order_statuses_url, params: { order_status: { complete: @order_status.complete, orderid: @order_status.orderid, orderstatusid: @order_status.orderstatusid } }
    end
  ...
  test "should update order_status" do
    patch order_status_url(@order_status), params: { order_status: { complete: @order_status.complete, orderid: @order_status.orderid, orderstatusid: @order_status.orderstatusid } }
