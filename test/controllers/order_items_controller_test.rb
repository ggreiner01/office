...
class OrderItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_item" do
    assert_difference('OrderItem.count') do
      post order_items_url, params: { order_item: { cart_id: @order_item.cart_id, supply_id: @order_item.supply_id } }
    end
  ...
  test "should update order_item" do
    patch order_item_url(@order_item), params: { order_item: { cart_id: @order_item.cart_id, supply_id: @order_item.supply_id } }
